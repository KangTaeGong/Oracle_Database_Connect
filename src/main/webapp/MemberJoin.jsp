...
<body>
	...
	<tr height="50">
		...
		<td width="350" align="center"> <input type="text" name="id" size="40" placeholder="ID">
		</td>
	</tr>
	<tr height="50">
		<td width="150" align="center"> 패스워드 </td>
		<td width="350" align="center"> <input type="password" name="pass1" size="40" placeholder="Password">
		</td>
	</tr>
	<tr height="50">
